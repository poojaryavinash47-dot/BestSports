...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md glass-card border-none z-10">
        <Tabs defaultValue="login" className="w-full">
          <TabsList className="grid w-full grid-cols-2 rounded-t-xl h-12 bg-muted/50 p-1">
            <TabsTrigger value="login" className="rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-bold">LOGIN</TabsTrigger>
            <TabsTrigger value="signup" className="rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground font-bold">SIGN UP</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="login">
            ...
            <form onSubmit={handleAuth}>
              ...
              <CardFooter className="flex flex-col gap-4">
                <Button className="w-full h-12 bg-primary text-primary-foreground font-bold neon-glow-blue" disabled={isLoading}>
          ...
          <TabsContent value="signup">
            <CardHeader>
              ...
              <CardDescription>Join our community of athletes today.</CardDescription>
            </CardHeader>
            <form onSubmit={handleAuth}>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                    <Input id="signup-email" type="email" placeholder="name@example.com" className="pl-10 h-11" required />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                    <Input id="signup-password" type="password" className="pl-10 h-11" required />
                  </div>
                </div>
              </CardContent>
              <CardFooter>
